...
\033[1;94m ┈┈┈▕▕ARYAN▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕ARYAN▏▏┈┈┈
...
\033[1;96m................\033[1;93mARYAN DAD HERE\033[1;91m...............

\033[1;96m................\033[1;93m✬🄵🄰🄲🄴🄱🄾🄾🄺✬\033[1;91m..............

\033[1;96m░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░

\033[1;91m☞ Auther     : ARYAN_YOUR_EX_DAD

\033[1;92m☞ WhatsApp   : 9841189421

\033[1;95m☞ YouTube    : https://youtube.com/channel/UCTAWAv-ylKGdF4sXiqgTimw
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update ARYAN Tool')

	print (S + '[' + P + '☞3' + S + ']' + S + ' ARYAN FAMILY WhatsApp Group')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/ARYAN_DAD')

	    os.system('cd $HOME && git clone https://github.com/ARYANDADHERE/ARYAN')
	    ...
	    psb('WhatsApp Num 9841189421✓')

	    psb('WellCome To ARYAN FAMILY')

	    psb('Congratulations ARYAN'S Tool Has Been Updated Successfully')

	    psb('🔓User Name☆ ARYAN✓')

	    psb('🔓Password ☆ GOD✓')

	    psb('SEND ME REQ IN FB (Link.Copy.Kina.Hanis.Dalit)✓')

	    psb('Please Login Again')

	    time.sleep(2)

	    os.system('cd $HOME/ARYAN && python2 A4.py')
